...
class Student(User):
    ...
    topics_of_interest = db.relationship('ResearchFields', secondary = studentFields, primaryjoin=(studentFields.c.student_id==id),
                                          backref=db.backref('studentFields',lazy='dynamic'),lazy='dynamic')
...
class Faculty(User):
    ...
    def __repr__(self):
         return '<Faculty {} - {} - {}>'.format(self.id, self.firstname, self.lastname)
...
class ResearchFields(db.Model):
    ...
    student_interested = db.relationship('Student', secondary = studentFields, primaryjoin=(studentFields.c.field_id==id),
                                          backref=db.backref('studentFields',lazy='dynamic'),lazy='dynamic')
