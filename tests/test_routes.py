...
from app.Model.models import Faculty, Student, User, ResearchPosition, Applications, ResearchField, ProgrammingLanguage, Department, Major
...
def test_apply_for_position(request,test_client,init_database):
    ...
    apply_response = test_client.post(f'/apply/{position_id}', data={
